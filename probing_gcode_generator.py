...
# gcode params
# x_coords = [0, 404, 900]
x_min, x_max, x_gridpoints = 0, 500, 251  # change these values for x reach and gridpoints
y_min, y_max, y_gridpoints = 0, 10, 2  # change these values for y reach and gridpoints
xy_feedrate = 6000
z_feedrate = 300
dwell_period = 2
